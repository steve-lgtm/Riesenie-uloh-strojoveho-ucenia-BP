\documentclass[a4paper,helvetica]{tukediphc}
%% -----------------------------------------------------------------
%% tento subor ma kodovanie utf-8
%%
%% na kompilaciu pouzivajte prikaz:
...
\hypersetup{
   ...
   pdfsubject={Záverečná práca}, % Diplomov\'a, Dizerta\v{c}n\'a
   baseurl={http://www.tuke.sk}
}

\usepackage[toc,nonumberlist,noredefwarn]{glossaries}  % slovnik terminov a skratiek
...
\konzultanta{Leslie B. Lamport}
\konzultantb{Donald E. Knuth}
\univerzita{Technická univerzita v~Košiciach}
\fakulta{Fakulta elektrotechniky a informatiky}
\skratkafakulty{FEI}
\katedra{Katedra počítačov a informatiky}
\skratkakatedry{KPI}
\odbor{Informatika}  % pozri zadávací list
...
%skratiek}
\input{glossary.tex}
\printglossaries % vlozenie zoznamu skratiek a symbolov
\newpage
